...
let storyText = '外の気温は華氏5度でとても暑かったです。:insertx:はその日、海で:inserty:を拾いました。名前をボブと名付けました。体重250ポンドのとても:insertz:な子でした。:insertx:は幸せに暮らしました。';
...
function result() {
  ...
  if(document.getElementById("jp").checked) {
    ...
    newStory = newStory.replace('250ポンド',weight);
  }
